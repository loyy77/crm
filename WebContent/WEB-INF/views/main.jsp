...
<script src="<c:url value="resources/ligerUI/js/plugins/ligerTree.js"/>" type="text/javascript" ></script>
...
<style type="text/css"> 
    ...
    .space{ color:#E7E7E7;}
    /* 顶部 */ 
    .l-topmenu{ margin:0; padding:0; height:31px; line-height:31px; background:url('resources/images/top.jpg') repeat-x bottom;  position:relative; border-top:1px solid #1D438B;  }
    .l-topmenu-logo{ color:#E7E7E7; padding-left:35px; line-height:26px;background:url('resources/images/topicon.gif') no-repeat 10px 5px;}
 	...
 	<div style="width:200px; height:300px; margin:0px; float:left;  overflow:auto;  ">
        ...
        <div position="center" id="framecenter" style="color:black;"> 
            <div tabid="home" title="我的主页" style="height:300px" >
                <iframe frameborder="0" name="home" id="home" src="<c:url value="resources/welcome.htm"/>"></iframe>
            </div> 
        </div> 
        
    </div>
    <div  style="height:32px; line-height:32px; text-align:center;">
            Copyright   &copy; 2012-2012 www.ligerui.com
    </div>
