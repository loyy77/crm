...
public class UsersDaoImpl implements UsersDao {
	...
	public List<Users> findCustomerManager() {
		return jdbcTemplate.query("select * from users where roleId=?",
				new Object[] { Constant.ROLE_CUSTOMER_MANAGER },
				new UsersMapper());
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.crm.dao.impl.UsersDao#getByNameAndPassword(java.lang.String,
	 * java.lang.String)
	 */
	@Override
	public Users getByNameAndPassword(String loginName, String loginPass) {
		if (this.checkUserIsExist(loginName, loginPass)) {
			...
			Users u = jdbcTemplate.queryForObject(sql, new Object[] {
					loginName, loginPass }, new UsersMapper());
			return u;
		}
		return null;
		...
		try {
			u = this.jdbcTemplate.queryForObject(
					...
					new Object[] { userId }, new RowMapper<Users>() {
						...
						@Override
						public Users mapRow(ResultSet rs, int arg1)
								throws SQLException {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.crm.dao.impl.UsersDao#checkUserIsExist(java.lang.String,
	 * java.lang.String)
	 */
	@Override
